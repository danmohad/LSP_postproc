...
LSP_data = np.load(LSP_PATH + '\LSP_data_processed_azimuthal.npz')
...
plt.figure(1).text(0.15,0.2,'x/D = {:1.1f}'.format(st_array[0]))
plt.figure(1).text(0.15,0.4,'x/D = {:1.1f}'.format(st_array[1]))
plt.figure(1).text(0.15,0.6,'x/D = {:1.1f}'.format(st_array[2]))
plt.figure(1).text(0.15,0.8,'x/D = {:1.1f}'.format(st_array[3]))  
plt.figure(2).text(0.15,0.2,'x/D = {:1.1f}'.format(st_array[0]))
plt.figure(2).text(0.15,0.4,'x/D = {:1.1f}'.format(st_array[1]))
plt.figure(2).text(0.15,0.6,'x/D = {:1.1f}'.format(st_array[2]))
